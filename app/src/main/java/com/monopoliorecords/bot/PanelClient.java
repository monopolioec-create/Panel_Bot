...
public class PanelClient {
    ...
    public JSONObject claim(String url,String code)throws Exception{
        ...
        JSONObject b=new JSONObject().put("code",code).put("device_uuid",Prefs.deviceUuid(c)).put("name","Teléfono Monopoly Records");
    ...
    public void heartbeat(JSONObject status)throws Exception{ JSONObject b=new JSONObject().put("status",status).put("app_version","0.1.0"); HttpJson.call("POST",base()+"/api/v1/device/heartbeat.php",b,h()); }
